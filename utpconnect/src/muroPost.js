...
const Wall = ({ posts, onPostCreate }) => {
    ...
    const handleCommentSubmit = (postId, event) => {
        event.preventDefault(); // Evita el comportamiento predeterminado del formulario (recarga de la página)
        console.log(`Adding comment to post ${postId}: ${newComment}`); // Limpia el campo de comentario después de enviarlo
        setNewComment('');
    };
